        ...
        <ul class="icongroup">
          <li>
            <el-button class="export_btn"
                       ...
                       v-permission="['dcp:system:actionLog:export']">
...
export default {
  ...
  data() {
    return {
      exportUrl: this.$urlList.userdolog.exportUrl,
      detailUrl: {
        isTime: 'optionTime',
        id: 'id',
      },
      arrList: [
        ...
        [
          ...
          { type: 'select', name: 'operationDicType', value: '', param: 'T_YHCZRZ_0002', label: '操作类型', span: 6 },
          { type: 'input', name: 'search_LIKE_login_ip', value: '', label: 'IP', span: 6, rule: [{ max: 512, message: '长度不超过512位', trigger: 'blur' }] },
        ],
        [{ type: 'input', name: 'search_LIKE_operate_user_id', value: '', label: '操作对象', span: 6, rule: [{ max: 512, message: '长度不超过512位', trigger: 'blur' }] }],
      ],
      paramTable: {
        bussName: 'userdolog',
        tableHeader: [
