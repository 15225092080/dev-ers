    ...
    <div class="badge-mc">
      <p v-for="(item,index) in value"
        ...
        <template v-for="subitem in item.menus">
          <template v-if="subitem.count">
            <el-badge :value="subitem.count"
                      class="item"
                      :key="subitem.link"
                      v-if="subitem.link">
              <el-button type="primary"
                         size="small"
                         @click="getRoute(subitem.link)">{{ subitem.name }}</el-button>
            </el-badge>
            <el-badge value=""
                      class="item"
                      :key="subitem.link"
              ...
              <el-button size="small"
                         disabled>{{ subitem.count }}</el-button>
            </el-badge>

          </template>
          <template v-else>
            <el-badge v-if="subitem.udattr"
                      is-dot
                      class="item"
                      :key="subitem.link">
              <el-button type="primary"
