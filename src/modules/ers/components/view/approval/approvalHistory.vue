  ...
  <div class="querypage">
    ...
    <el-card class="paddingtop">
      <div slot="header"
           class="clearfix">
        <span>
          <i class="DHCiconfont">&#xe66a;</i>企评已审批数据列表
        </span>
      </div>
      <div>
...
export default {
  ...
  data() {
    return {
      ...
      detailUrl: {
        url: this.$urlList.approved.getValUrl,
