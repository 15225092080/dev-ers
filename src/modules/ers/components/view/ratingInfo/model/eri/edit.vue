  ...
  <div style="width:85%"
    ...
    <el-form ref="formItem"
      ...
      <div>
        ...
        <el-row>
          <!-- <el-col :span="12">
            <el-form-item label="内部机构代码"
                          prop="deptCode">
              <v-select paramtype="E_ReportFormdel"
                        v-model="formItem.deptCode"
            ...
            <div class="grid-content">
              ...
              <table class="dataLeft">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>销售商品、提供劳务收到的现金</span></td>
                    <td>2</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>收到的税费返还</span></td>
                    <td>3</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>收到其他与经营活动有关的现金</span></td>
                    <td>4</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>经营活动现金流入小计</b></td>
                    <td>5</td>
                    <td>
                      <el-form-item prop="totCasIfoa"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  @change="minusNetCasFfoa(clacTotIncAl)"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="star">*</span><span>购买商品、接受劳务支付的现金</span></td>
                    <td>6</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>支付给职工以及为职工支付的现金</span></td>
                    <td>7</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>支付的各项税费</span></td>
                    <td>8</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>支付其他与经营活动有关的现金</span></td>
                    <td>9</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>经营活动现金流出小计</b></td>
                    <td>10</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>经营活动产生的现金流量净额</b></td>
                    <td>11</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>收回投资收到的现金</span></td>
                    <td>13</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>取得投资收益收到的现金</span></td>
                    <td>14</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>处置固定资产、无形资产和其他长期资产收回的现金净额</span></td>
                    <td>15</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>处置子公司及其他营业单位收到的现金净额</span></td>
                    <td>16</td>
                    <td>
                      <el-form-item prop="netCasIodosaobe"
                                    label-width="0px">
                        <el-input class="inputCls"
                                  name="netCasIodosaobe"
                                  v-model="formItem.netCasIodosaobe"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="star">*</span><span>收到其他与投资活动有关的现金</span></td>
                    <td>17</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>投资活动现金流入小计</b></td>
                    <td>18</td>
                    <td>
                      <el-form-item prop="totCasIfia"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  @change="minusNetCasFfia(clacTotIncAl)"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="star">*</span><span>购建固定资产、无形资产和其他长期资产支付的现金</span></td>
                    <td>19</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>投资支付的现金</span></td>
                    <td>20</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>取得子公司及其他营业单位支付的现金净额</span></td>
                    <td>21</td>
                    <td>
                      <el-form-item prop="netCasOoposaobu"
                                    label-width="0px">
                        <el-input class="inputCls"
                                  name="netCasOoposaobu"
                                  v-model="formItem.netCasOoposaobu"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="star">*</span><span>支付其他与投资活动有关的现金</span></td>
                    <td>22</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>投资活动现金流出小计</b></td>
                    <td>23</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>投资活动产生的现金流量净额</b></td>
                    <td>24</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>吸收投资收到的现金</span></td>
                    <td>26</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>取得借款收到的现金</span></td>
                    <td>27</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>收到其他与筹资活动有关的现金</span></td>
                    <td>28</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>筹资活动现金流入小计</b></td>
                    <td>29</td>
                    <td>
                      <el-form-item prop="totCasIffa"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  @change="minusNetCasFffa(clacTotIncAl)"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="star">*</span><span>偿还债务支付的现金</span></td>
                    <td>30</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>分配股利、利润或偿付利息支付的现金</span></td>
                    <td>31</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><span>支付其他与筹资活动有关的现金</span></td>
                    <td>32</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>筹资活动现金流出小计</b></td>
                    <td>33</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>筹资活动产生的现金流量净额</b></td>
                    <td>34</td>
                    <td>
                  ...
                  <tr>
                    <td><span class="star">*</span><b>四、汇率变动对现金及现金等价物的影响</b></td>
                    <td>35</td>
                    <td>
                      <el-form-item prop="effOfErcoc"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  @change="clacTotIncAl"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="star">*</span><b>五、现金及现金等价物净增加额</b></td>
                    <td>36</td>
                    <td>
                      <el-form-item prop="netIncIcace"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  @change="calcObj.clacTotTheAl(self)"
                                  :disabled="false"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="star">*</span><span>加：期初现金及现金等价物余额</span></td>
                    <td>37</td>
                    <td>
                      <el-form-item prop="iniCasAceb"
                                    label-width="0px">
                        <el-input class="inputCls"
                                  name="iniCasAceb"
                                  v-model="formItem.iniCasAceb"
                                  @change="calcObj.clacTotTheAl(self)"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    <td><span class="star">*</span><b>六、期末现金及现金等价物余额</b></td>
                    <td>38</td>
                    <td>
                      <el-form-item prop="theFinCaceb"
                                    label-width="0px">
                        <el-input class="inputCls"
                                  name="theFinCaceb"
                                  v-model="formItem.theFinCaceb"
                                  :disabled="false"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
              ...
              <table class="dataRight">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>49</td>
                    <td>
                      <el-form-item prop="proOrLfcifv"
                                    label-width="0px">
                        <el-input class="inputCls"
                                  name="proOrLfcifv"
                                  v-model="formItem.proOrLfcifv"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>52</td>
                    <td>
                      <el-form-item prop="defIncTa"
                                    label-width="0px">
                        <el-input class="inputCls"
                                  name="defIncTa"
                                  v-model="formItem.defIncTa"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>53</td>
                    <td>
                      <el-form-item prop="defIncTl"
                                    label-width="0px">
                        <el-input class="inputCls"
                                  name="defIncTl"
                                  v-model="formItem.defIncTl"></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                  <tr>
...
export default {
  ...
  data() {
    return {
      ...
      collapseList: {
        activeNames: ['eff'], // 默认显示那个折叠栏 没有默认显示全部。
        param: {
    ...
    init() {
      ...
      if (this.$store.getters.operatState == 'edit' && this.$route.query.id) {
        setTimeout(() => {
          ...
          let url = this.$urlList.eri.getValUrl;
  ...
  created() {
    ...
    //   that.rules[arr0[i]] = [{}];
    //   that.rules[arr0[i]] = [];
    //   // 当字段为 经营活动产生的现金流量净额、投资活动产生的现金流量净额、筹集活动产生的现金流量净额、现金及现金等价物净增加额、期末现金及现金等价物余额 时，不进行数字校验
    //   if (
    //     arr0[i] == 'netCasFfoa' ||
    //     arr0[i] == 'netCasFfia' ||
    //     arr0[i] == 'netCasFffa' ||
