  ...
  <div style="width:85%;">
    ...
    <!-- <div class="historyGroup">
      <el-row class="historyBtn">
        <el-button type="primary"
                   plain
                   @click="historyBtnEff">查看报送历史</el-button>
      </el-row>
    </div> -->
    <el-form ref="formItem"
      ...
      <div>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="中心是否存在"
                          prop="centerExist">
              <v-select paramtype="CENTER_EXIST"
                        v-model="formItem.centerExist"
                        disabled="disabled"></v-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="操作员"
                          prop="operator">
              <el-input v-model="formItem.operator"
                        disabled="disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="入库时间"
                          prop="getTime">
              <el-input v-model="formItem.getTime"
                        disabled="disabled"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="修改时间"
                          prop="changeTime">
              <el-input v-model="formItem.changeTime"
                        disabled="disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="信息报告日期"
                          prop="rptDate">
              <el-input v-model="formItem.rptDate"
                        disabled="disabled"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="批次号"
                          prop="batchNum">
              <el-input v-model="formItem.batchNum"
                        disabled="disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="报文号"
                          prop="msgNum">
              <el-input v-model="formItem.msgNum"
                        disabled="disabled"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="报送状态"
                          prop="reportState">
              <v-select paramtype="REPORT_STATE"
                        v-model="formItem.reportState"
                        disabled="disabled"></v-select>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="数据状态"
                          prop="dataState">
              <v-select paramtype="DATA_STATE"
                        v-model="formItem.dataState"
                        disabled="disabled"></v-select>
            </el-form-item>
          </el-col>
          <!-- <el-col :span="12">
                    ...
                    <td>
                      <el-form-item prop="cashRecFsogoros"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  v-model="formItem.cashRecFsogoros"
                                  disabled></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                    ...
                    <td>
                      <el-form-item prop="netCrfdofaiaaolta"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  v-model="formItem.netCrfdofaiaaolta"
                                  disabled></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                    ...
                    <td>
                      <el-form-item prop="netCasIodosaobe"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  v-model="formItem.netCasIodosaobe"
                                  disabled></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                    ...
                    <td>
                      <el-form-item prop="casPaiTafaiaaolta"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  v-model="formItem.casPaiTafaiaaolta"
                                  disabled></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                    ...
                    <td>
                      <el-form-item prop="netCasOoposaobu"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  v-model="formItem.netCasOoposaobu"
                                  disabled></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                    ...
                    <td>
                      <el-form-item prop="casPayFdodopaie"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  v-model="formItem.casPayFdodopaie"
                                  disabled></el-input>
                      </el-form-item>
                    </td>
                  </tr>
                    ...
                    <td>
                      <el-form-item prop="losOnDofaiaaolta"
                        ...
                        <el-input class="inputCls"
                                  ...
                                  v-model="formItem.losOnDofaiaaolta"
                                  disabled></el-input>
                      </el-form-item>
                    </td>
                  </tr>
    ...
    <!-- 查询报送历史列表页 -->
    <effHistory v-if="effHistory"
                :paramDetail="paramDetail"
                @closeChild="closeChild"
                ref="effHistory"
                :vis.sync="effHistory"></effHistory>
  </div>
</template>
<script>
import vCollapse from '@/modules/ers/components/common/collapse.vue';
import effHistory from './historyList';
export default {
  name: 'child',
  components: {
    vCollapse,
  ...
  methods: {
    // 报送历史列表页 弹出对话框
    historyBtnEff() {
      this.effHistory = true;
      this.paramDetail = {
        title: '07版现金流量表-报送历史列表页',
        dialogTitle: '',
        url: null,
        id: this.formItem.id,
      };
