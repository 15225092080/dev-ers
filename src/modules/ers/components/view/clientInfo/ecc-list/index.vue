  ...
  <div class="querypage">
    ...
    <el-card class="paddingtop">
      <div slot="header" class="clearfix">
        <span>
          <i class="DHCiconfont">&#xe66a;</i>企业间关联关系信息列表
        </span>
        <ul class="icongroup">
          <li>
            <el-button type="primary" plain @click="addModal" v-permission="['crse:basicinfo:ecc:create']">
              <i class="DHCiconfont">&#xe6c3;</i>创建
            </el-button>
          </li>
          <li>
            <el-button type="primary" @click="editFun" v-permission="['crse:basicinfo:ecc:update']">
              <i class="DHCiconfont">&#xe668;</i>编辑
            </el-button>
          </li>
          <li>
            <el-button type="danger" @click="deleteFun" v-permission="['crse:basicinfo:ecc:delete']">
    ...
    return {
      ...
      arrList: [
        [
          ...
          {type: 'input', name: 'search_LIKE_entName', value: '', label: 'A企业名称', span: 6},
          {type: 'select', name: 'search_EQ_entCertType', value: '', param: 'E_InfoIDType2', label: 'A企业身份标识类型', span: 6},
          {type: 'input', name: 'search_LIKE_entCertNum', value: '', label: 'A企业身份标识号码', span: 6}
        ],
        [
      ...
      detailUrl: {
        ...
        url: this.$urlList.ecc.getValUrl,
        delUrl: this.$urlList.ecc.delUrl,
        paramDataId: 'id', // 字段名
        id: 'id', // 获取表格数据的字段名
        resId: '' // 获取的id
      },
