<template>
  <div>
    ...
    <eccHistory v-if="eccHistory" :eccHis="eccHis" @closeChild="closeChild" ref="eccHistory"  :vis.sync="eccHistory"></eccHistory>
  </div>
</template>
<script>
import MinXin from '@/common/script/mixin';
import eccHistory from './ecc-historyList';
export default {
  name: 'child',
  components: {
    eccHistory
    ...
    init() {
      ...
      this.arrList = [
        [
          ...
          {type: 'input', name: 'entName', value: '', label: 'A企业名称', span: 12, disabled: true, noReset: true
          }
        ],
        [
          {type: 'select', name: 'entCertType', value: '', param: 'E_InfoIDType2', label: 'A企业身份标识类型', span: 12, disabled: true, noReset: true
          },
          {type: 'input', name: 'entCertNum', value: '', label: 'A企业身份标识号码', span: 12, disabled: true, noReset: true
          }
        ],
        [
          {type: 'input', name: 'assoEntName', value: '', label: 'B企业名称', span: 12, disabled: true, noReset: true
          },
          {type: 'select', name: 'assoEntCertType', value: '', param: 'E_InfoIDType2', label: 'B企业身份标识类型', span: 12, disabled: true, noReset: true
          }
        ],
        [
          {type: 'input', name: 'assoEntCertNum', value: '', param: '', label: 'B企业身份标识号码', span: 12, disabled: true, noReset: true
          },
          {type: 'select', name: 'assoType', value: '', param: 'E_AssociationType', label: '关联关系类型', span: 12, disabled: true, noReset: true
          }
        ],
        [
          {type: 'select', name: 'assoSign', value: '', param: 'E_AssociationFlag', label: '证件关联关系有效标志', span: 12, disabled: true, noReset: true
          },
