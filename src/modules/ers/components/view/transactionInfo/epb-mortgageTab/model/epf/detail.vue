...
export default {
  ...
  methods: {
    ...
    init() {
      this.arrList = [
        [
          {type: 'select', name: 'impType', value: '', param: 'E_ImpType', label: '质物种类', span: 12, disabled: true
          },
          {type: 'input', name: 'ipmVal', value: '', label: '质物价值', span: 12, disabled: true}
        ],
        [
          {type: 'select', name: 'impCy', value: '', param: 'E_Cy', label: '币种', span: 12, disabled: true
          },
          {type: 'input', name: 'pawnName', value: '', label: '出质人名称', span: 12, disabled: true},
          // {type: 'select', name: 'ippc', value: '', param: 'E_InfoIDType', label: '出质人身份类别', span: 12, disabled: true, eventChange: true // 关联字典
          // }
        ],
        [
          {type: 'select', name: 'pawnCertType', value: '', customOption: {}, label: '出质人身份标识类型', span: 12, disabled: true
          },
          {type: 'input', name: 'pawnCertNum', value: '', label: '出质人身份标识号码', span: 12, disabled: true
          }
        ],
        [
