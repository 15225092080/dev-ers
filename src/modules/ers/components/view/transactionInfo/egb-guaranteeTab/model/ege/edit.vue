  ...
  methods: {
    eventChange(obj) {
      ...
      _this.common.onselect('infoIdType', obj, function () { // 监听下拉框事件 参数为绑定的下拉字段、change事件返回、回调函数
        ...
        _this.ipType = obj.e;
        let infoIdType = _this.$refs.formItem.formItem.infoIdType;
        // 监听下拉框事件 参数为绑定的下拉字段、change事件返回、回调函数
        _this.getSystemId(param,infoIdType);
      });
          ...
          _this.common.Control(_this.arrList, {
            ...
            'guarNum': {
              ...
              rule: [
                ...
                {validator: _this.validator.noSpecialCaracters, trigger: 'blur'}
              ]
            }
          });
        } else {
    ...
    async getSystemId(param,infoIdType) {
    ...
    callbackFun(formItem) {
        ...
        this.callback(formItem,'ege',param)
    },
    init() {
