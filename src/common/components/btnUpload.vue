<template>
  <div>
    ...
    >
          <el-button size="small" type="primary" class="right uploadBtn" :style="uploadData.styleBtn ? uploadData.styleBtn : {}" :disabled="uploadData.uploadDisabled"><i v-if="uploadData.iconBtn" class="DHCiconfont" v-html="uploadData.iconBtn"></i>{{uploadData.btnText}}</el-button>
    </file-upload>
    <!-- <el-dialog
...
.file-uploads >>> .el-button--primary:hover{
    background: #FFFFFF !important;
    border-color: #3075c7 !important;
